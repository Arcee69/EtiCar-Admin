...
const DeleteRoles = ({ isOpen, role, onClose, onDelete }: DeleteRolesProps) => {
  const handleDelete = () => {
    if (!role) {
      return
    }
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-NEUTRAL-100">Delete Role</h2>
          </div>
          ...
          <button
            ...
            aria-label="Close delete role modal"
          >
